...
import { socketEpic$, registerUserSocketEpic$ } from './services/socketEpic';
...
const store = createStore(messageReducer, { messages: [], username: randomUser(), toUserName: randomUser(), users: []}, applyMiddleware(epicMiddleware));
